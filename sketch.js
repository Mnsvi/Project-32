...
function setup() {
    ...
    block19 = new Block(170,300,30,40);
    block20 = new Block(200,300,30,40);
    block21 = new Block(230,300,30,40);

    block22 = new Block(200,250,30,40);

    polygon = new Polygon(100, 100, 10,10);
